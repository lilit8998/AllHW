...
public interface Commands {
    ...
    static void printCommands(){
        ...
        System.out.println("Please input " + SEARCH_LESSON_BY_NAME + " SEARCH_LESSON_BY_NAME");
        System.out.println("Please input " + SEARCH_STUDENT_BY_LESSON_NAME + " for SEARCH_STUDENTS_BY_LESSON_NAME");
        System.out.println("Please input " + CHANGE_STUDENT_LESSON + " for CHANGE_STUDENT_LESSON");
        System.out.println("Please input " + CHANGE_STUDENT_PHONE + " for CHANGE_STUDENT_PHONE -  with mail");
    }
}
